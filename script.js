        ...
        grid.innerHTML = products.map(product => `
            <div class="product-card bg-white rounded-3xl overflow-hidden border border-gray-100 flex flex-col shadow-sm">
                <div class="relative aspect-square bg-gray-100 overflow-hidden">
                    <img src="${product.image}" class="w-full h-full object-cover transform hover:scale-105 transition duration-500">
                </div>
...
window.onload = function() {
    ...
    if (form) {
        form.onsubmit = function(e) {
            ...
            const scriptURL = 'https://script.google.com/macros/s/AKfycbwmzBv5uxQqcLGyS4XVSFn8MQTRfSaO5eBturPa2cFhZOmkcsXjhDIPf6mPU1o19kh7/exec';
